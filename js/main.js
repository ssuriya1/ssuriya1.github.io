class Portfolio {
  ...
  updateTitle() {
    ...
    document.querySelector(".logo-text").textContent =
      this.config.personal.logo;
  }

  updateNavigation() {
    const navMenu = document.querySelector(".nav-menu");
    navMenu.innerHTML = this.config.navigation
      .map(
        (item) =>
  ...
  updateHero() {
    ...
    document
      .getElementById("get-in-touch-btn")
  ...
  updateAbout() {
    ...
    aboutText.innerHTML = `
            ...
            <div class="stats">
                <div class="stat">
                    <span class="stat-number" data-count="${this.config.experience.items.length}">${this.config.experience.items.length}</span>
                    <span class="stat-label">Certifications</span>
                </div>
                <div class="stat">
                    <span class="stat-number" data-count="${this.getTechnologiesCount()}">${this.getTechnologiesCount()}</span>
    ...
    techOrbit.innerHTML = this.config.about.techOrbit
      .map(
        (tech, index) => `
  ...
  updateSkills() {
    ...
    skillsGrid.innerHTML = Object.entries(this.config.about.skills)
      .map(
        ([category, skills]) => `
  ...
  updateExperience() {
    ...
    let experienceSection = document.querySelector("#certifications");
  ...
  updateContact() {
    ...
    contactForm.innerHTML = `
            ${this.config.contact.form.fields
              .map((field) => {
  ...
  getTechnologiesCount() {
    let count = 0;
    Object.values(this.config.about.skills).forEach((skillArray) => {
  ...
  setupCursor() {
    ...
    const interactiveElements = document.querySelectorAll(
      "a, button, .logo-text, .nav-link, .btn, .social-card, .experience-link",
    );
  ...
  setupButtonHandlers() {
    document.getElementById("view-work-btn").href =
      this.config.projects.githubUrl;
